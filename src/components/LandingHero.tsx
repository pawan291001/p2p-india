  ...
  <>
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 pt-16 pb-20 sm:px-6 sm:pt-24 sm:pb-28 relative">
        ...
        {/* Trust Badges */}
        <div className="mt-14 grid grid-cols-2 gap-3 sm:grid-cols-4 animate-fade-up" style={{ animationDelay: "200ms" }}>
          {TRUST_BADGES.map((b) => (
            <div
              key={b.label}
    ...
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {FEATURES.map((f, i) => (
          <div
            key={f.title}
            className="group rounded-xl border border-border bg-card p-5 transition-shadow hover:shadow-lg hover:shadow-primary/5 animate-fade-up"
    ...
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {STEPS.map((s, i) => (
          <div
            key={s.n}
            className="relative rounded-xl border border-border bg-card p-5 animate-fade-up"
